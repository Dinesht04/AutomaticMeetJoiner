...
const url = "https://meet.google.com/use-hyxf-mva";
...
const joinClass = async (meetingData) => {
  ...
  async function tryJoinMeeting() {
    ...
    try {
      const joinButtonXPath =
        "#yDmH0d > c-wiz > div > div > div:nth-child(29) > div.crqnQb > div > div.gAGjv > div.vgJExf > div > div > div.d7iDfe.NONs6c > div.shTJQe > div.jtn8y > div.XCoPyb > div > button";
      await page.waitForSelector(
        "#yDmH0d > c-wiz > div > div > div:nth-child(30) > div.crqnQb > div > div.gAGjv > div.vgJExf > div > div > div.d7iDfe.NONs6c > div.shTJQe > div.jtn8y > div.XCoPyb > div > button",
